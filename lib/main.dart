...
import 'package:community_classroom/router.dart';
...
void main() async {
  ...
  //provider scope widget contains the state of providers to read the provider must be at the root widget
